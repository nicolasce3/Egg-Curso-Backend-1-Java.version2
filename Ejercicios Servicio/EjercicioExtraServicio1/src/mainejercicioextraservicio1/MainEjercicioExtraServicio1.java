 ...
 * operaciones que se podrán realizar son las siguientes: a) Método
 * getDiscriminante(): devuelve el valor del discriminante (double). El
 * discriminante tiene la siguiente fórmula: (b^2) 4*a*c b) Método
 ...
 * obtenerRaices(): llama a tieneRaíces() y si devolvió́true, imprime las 2
 * posibles soluciones. e) Método obtenerRaiz(): llama a tieneRaiz() y si
 * devolvió́true imprime una única raíz. Es en el caso en que se tenga una única
 * solución posible. f) Método calcular(): esté método llamará tieneRaices() y a
 * tieneRaíz(), y mostrará por pantalla las posibles soluciones que tiene
 * nuestra ecuación con los métodos obtenerRaices() o obtenerRaiz(), según lo
 * que devuelvan nuestros métodos y en caso de no existir solución, se mostrará
...
public class MainEjercicioExtraServicio1 {
    ...
    public static void main(String[] args) {
        Raices raices = new Raices(1, 4, 2);
